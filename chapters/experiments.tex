...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|l|}
        ...
        Attribute    & Simulator                         & Filter \\ \hline
        ...
        Inertia Tensor & $\text{diag}(1,1,1) \, kg\cdot m^{2}$ & $\text{diag}(1.05,0.95,1.02) \, kg\cdot m^{2}$ \\ \hline
        \multicolumn{3}{|c|}{Initial States} \\ \hline
        Attribute    & Simulator           & Filter \\ \hline
        Latitude     & $-33.90^{\circ}$    & $-33.90^{\circ}$ \\
        Longitude    & $18.41^{\circ}$     & $18.41^{\circ}$ \\
        ...
        Yaw Rate     & $0^{\circ}/s$       & $0^{\circ}/s$ \\ \hline
    \end{tabular}
    \caption{Simulation and Filter Constants and Initial States}
...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{Camera characteristics for the simulated and Simera Sense cameras.}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|}
        \hline
        \textbf{Attribute} & \textbf{P} & \textbf{Q} \\ \hline
        $r_x$ & $1000 \, m$ & $100 \, m$ \\
        $r_y$ & $1000 \, m$ & $100 \, m$ \\
        $r_z$ & $1000 \, m$ & $100 \, m$ \\ \hline
        $v_x$ & $100 \, m/s$ & $50 \, m/s$ \\
        $v_y$ & $100 \, m/s$ & $50 \, m/s$ \\
        $v_z$ & $100 \, m/s$ & $50 \, m/s$ \\ \hline
        Att   & $10^{\circ}$ & $5^{\circ}$ \\ \hline
        $w_x$ & $1^{\circ}/s$ & $0.5^{\circ}/s$ \\
        $w_y$ & $1^{\circ}/s$ & $0.5^{\circ}/s$ \\
        $w_z$ & $1^{\circ}/s$ & $0.5^{\circ}/s$ \\ \hline
    \end{tabular}
    \caption{Initial covariance ($P$) and process noise ($Q$) parameters for each state variable.}
...
\noindent
To evaluate the performance and contribution of the Earth Tracker within pose estimation, a series of systematic sensor tests are conducted. These tests isolate and compare different sensor configurations to assess accuracy, robustness, and the complementary nature of vision-based and traditional navigation sensors. Four configurations are evaluated: the Earth Tracker standalone, the traditional ADCS suite (GPS, gyroscope, coarse sun sensor, and magnetometer) standalone, the star tracker integrated with the ADCS suite, and the Earth Tracker integrated with the ADCS suite. Through this comparison, the study assesses the Earth Tracker's relative accuracy, its ability to enhance the performance of the ADCS suite, and its potential to serve as an alternative to star trackers in resource-constrained missions. The results establish a foundation for understanding the practical applicability of the Earth Tracker for autonomous satellite pose estimation.
...
\noindent
Figure \ref{fig:ETMeasurements} illustrates the comparison between the true and estimated Earth Tracker measurements for Feature 1, demonstrating close agreement between the two. The measurement error shown in Figure \ref{fig:ETMeasurementError} reveals that the discrepancy between true and estimated feature vectors remains below 200 meters, indicating high accuracy in the feature detection and back-projection process.
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/experiments/ETAttitudeError.pdf}
        \caption{ET attitude error for uncertainty of 10 m}
        \label{fig:ET10}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/experiments/ETAtt1500.pdf}
        \caption{ET attitude error for uncertainty of 1500m}
        \label{fig:ET1500}
    \end{subfigure}
    \caption{Comparison of Earth Tracker attitude error.}
    \label{fig:ETSError}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.48\linewidth]{figures/experiments/SuiteError.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/experiments/ETSuiteSystem.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/experiments/STSystem.pdf}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/experiments/ETSuiteAttitude.pdf}
    ...
    \begin{subfigure}[b]{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/experiments/STError.pdf}
